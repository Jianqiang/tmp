...
#test..
#p_dev='../working_data/dev.ctb5.pos.split.new'  # added .split, to use the splitted version
#p_test='../working_data/test.ctb5.pos.split.new'
#p_train='../working_data/train.ctb5.pos.split.new'

p_dev='../working_data/dev.ctb5.pos'    # <---- ### Oct 6, tmp change to try complete/raw version, rather than splitted one
